...
import { Expand, Minus, Moon, Plus, Shrink, Sun } from "lucide-react";
...
function PoemReaderControls({
  ...
  widthMode: "default" | "full";
  setWidthMode: React.Dispatch<React.SetStateAction<"default" | "full">>;
}) {
  return (
    <div className="flex items-center gap-1">
      ...
      <Button
        ...
        size="icon"
        onClick={() =>
          setWidthMode((w) => (w === "default" ? "full" : "default"))
        }
        title="Toggle width"
      >
        {widthMode === "full" ? (
...
function PoemReader() {
  ...
  const [widthMode, setWidthMode] = useState<"default" | "full">("default");
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        widthMode === "full" ? "w-full max-w-full" : "mx-auto max-w-4xl"
      )}
    >
      <Card
        className={cn(
          "transition-colors duration-300",
          isDark ? "dark bg-neutral-900 text-neutral-100" : "bg-white text-neutral-900"
        )}
      >
        <CardHeader>
          <div className="flex items-start justify-between gap-4">
            <div>
              <CardTitle>An Essay on Criticism</CardTitle>
              <CardDescription>by Alexander Pope</CardDescription>
            </div>
            <PoemReaderControls
              fontSize={fontSize}
        ...
        <CardContent>
          <div
            ...
            style={{ maxHeight: "60vh", fontSize, lineHeight: 1.8 }}
          >
